...
var startcontrollerCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		pc := controller.NewProvisionController(kubernetesClientSet, viper.GetString("provisioner-name"), iscsiProvisioner)
		//serverVersion.GitVersion, controller.Threadiness(1)
